...
# datainput(df_gen,df_load,SimDays,SimHours,HorizonHours,regup_margin,regdown_margin,data_name)
...
for day in range(start,end):
    ...
    # this is a function I should write
    ...
    df_veh_in=temp_vehicle_generation
