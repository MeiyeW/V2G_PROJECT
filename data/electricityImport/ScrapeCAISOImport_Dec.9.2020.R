...
inputMarket <- 'RTM'
inputYear <- 2019
rootDir = "/Users/meiyewang/Desktop/code/data/electricity import"
  ...
  while(activeDay <= end){
    ...
    if ((activeDay == end) && (start%%10000 == 1201)) { #%% is mod division
      getURL <- paste(baseURL,"resultformat=6&queryname=",query,
                      "&market_run_id=",market_run_id,'&tac_zone_name=Caiso_Totals&schedule=Import',"&startdatetime=",activeDay,"T08:00-0000",
